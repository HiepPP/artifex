...
This project is indexed by GitNexus as **artifex** (949 symbols, 2647 relationships, 82 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
